...
@objc public protocol AKPickerViewDataSource {
    ...
    @objc optional func pickerView(_ pickerView: AKPickerView, viewForItem item: Int) -> UIView
}
...
private protocol AKCollectionViewLayoutDelegate {
    ...
    func pickerViewDirectionForCollectionViewLayout(_ layout: AKCollectionViewLayout) -> UICollectionViewScrollDirection
}
...
open class AKPickerView: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AKCollectionViewLayoutDelegate {
    ...
    @IBInspectable open lazy var pickerViewScrollDirection: UICollectionViewScrollDirection = .horizontal
    ...
    fileprivate(set) var selectedItem: Int = 0
    ...
    */
    ...
    open func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        } else if let view = self.dataSource?.pickerView?(self, viewForItem: (indexPath as NSIndexPath).item) {
            cell.view.bounds =  CGRect(origin: CGPoint.zero, size: view.frame.size)
    ...
    open func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        var size = CGSize(width: self.interitemSpacing, height: height)
        if let title = self.dataSource?.pickerView?(self, titleForItem: (indexPath as NSIndexPath).item) {
            ...
            if let patternView = view as? PatternView {
                size.width += self.sizeForString(patternView.patternLabel.text! as NSString).width > 70 ? self.sizeForString(patternView.patternLabel.text! as NSString).width : 70
            } else {
    ...
    fileprivate func pickerViewDirectionForCollectionViewLayout(_ layout: AKCollectionViewLayout) -> UICollectionViewScrollDirection {
