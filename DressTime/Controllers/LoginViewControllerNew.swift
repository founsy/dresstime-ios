...
class LoginViewControllerNew : DTViewController {
...
extension LoginViewControllerNew : DressingSynchroDelegate {
...
extension LoginViewControllerNew : FBSDKLoginButtonDelegate {
